<template>
  <div class="entitiesCommentsTable">
    ...
    >
      ...
      <template #cell(content)="row">
        <div v-html="$options.filters.shortContent(row.item.content)" />
      </template>
    ...
    <b-modal ref="bulkModal" title="Delete Interview" @ok="bulkDelete" ok-variant="danger" ok-title="Delete">
      Are you sure that you want to delete selected interview?
    </b-modal>

    <b-modal ref="deleteModal" title="Delete Interview" @ok="remove" ok-variant="danger" ok-title="Delete">
      Are you sure that you want to delete this interview?
    </b-modal>
  </div>
</template>
<script>
